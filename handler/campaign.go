...
func (h *campaignHandler) GetCampaign(c *gin.Context) {
	...
	if err != nil {
		response := helper.APIResponse("Failed to get detail of campaign 1", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
	}
	...
	if err != nil {
		response := helper.APIResponse("Failed to get detail of campaign 2", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
	}
...
func (h *campaignHandler) UpdateCampaign(c *gin.Context) {
	...
	if err != nil {
		response := helper.APIResponse("Failed to update of campaign 1", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
	}
	...
	if err != nil {
		...
		response := helper.APIResponse("Failed to update campaign 1", http.StatusUnprocessableEntity, "error", errorMessage)
		c.JSON(http.StatusUnprocessableEntity, response)
		return
	}
